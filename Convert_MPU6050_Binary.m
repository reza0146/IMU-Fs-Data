...
function [converted_matrix, binary_matrix] = Convert_MPU6050_Binary()
    defaultDirectory = 'C:\Users\Reza\Google Drive\Master''s\IMU Sampling frequency\UBC_MPU6050_Code-master\data';
    [infiles, inpath] = uigetfile({'*', 'Binary Data File'},'Select a File',defaultDirectory);
